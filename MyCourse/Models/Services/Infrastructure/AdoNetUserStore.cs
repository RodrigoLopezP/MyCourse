...
namespace MyCourse.Models.Services.Infrastructure
{
        ...
        IUserConfirmation<ApplicationUser>
    {
        ...
        /*CancellationToken che l'è
            Serve pe dire al metodo di smettere di lavorare su quella operazione (magari da richiesta dell'utente), anche se ci sta già lavorando
        */
